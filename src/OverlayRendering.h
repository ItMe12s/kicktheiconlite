...
cocos2d::CCGLProgram* createStarburstFrameProgram(
    GLint* outPhase,
    GLint* outOrigin,
    GLint* outAspect,
    GLint* outFocusInner,
...
class StarburstFrameSprite : public cocos2d::CCSprite {
    ...
    GLint m_locOrigin = -1;
    GLint m_locAspect = -1;
    GLint m_locFocusInner = -1;
    GLint m_locFocusOuter = -1;
    float m_phase = 0.0f;
    float m_originX = 0.5f;
    float m_originY = 0.5f;
    float m_aspect = 1.0f;
    float m_focusInner = 0.06f;
    float m_focusOuter = 0.14f;

public:
    void setStarburstParams(
        float phase,
        float originX,
        float originY,
        float aspect,
    ...
    static StarburstFrameSprite* create(
